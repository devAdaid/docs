...
The expression is evaluated at the moment the command is executed, which allows using [custom variables](/ko/guide/custom-variables) inside the expressions:
