...
Constant expressions combined with [custom metadata providers](/ko/guide/ide-extension#metadata-providers) allow creating arbitrary autocompletion scenarios for the IDE extension.
