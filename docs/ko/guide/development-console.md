...
debug | Toggles [naninovel script debug](/ko/guide/naninovel-scripts#scripts-debug) window.
var | Toggles [custom variable editor](/ko/guide/custom-variables#variables-debug) window.
purge | When [Google Drive provider](/ko/guide/resource-providers#google-drive) is used, purges the downloaded resources cache.
...
reload | Performs [hot reload](/ko/guide/naninovel-scripts#hot-reload) of the currently played naninovel script. Works only in Unity editor.
